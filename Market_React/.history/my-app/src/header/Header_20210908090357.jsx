import "./header.css";
import "../../src/img/banner.jpg"
export default function Header() {
    return (
      <div>
      {/* banner header */}
      <div className="header">
        <img src={process.env.PUBLIC_URL + '/banner.jpg'} alt="" className="headeImg" />
      ...
      <div className="headernext">
        <divclassName="bannerImage"></div>
        <img src='../../my-app/img/hinh1.jpg' alt="" className="bannerImage" />
